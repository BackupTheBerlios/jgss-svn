 ...
 * <br>
 */
public class TestEntityEvent extends TestCase{
	public void testEntityEvent(){
        Entity entity =new GroupImpl();
        EntityEvent e = new EntityEventImpl(EntityEvent.ENTITY_DELETED,entity);
        
        assertTrue(e.getType()==EntityEvent.ENTITY_DELETED);
        assertTrue(entity.equals(e.getEntity()));
    }
}
